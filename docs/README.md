...
This directory documents the skills in this repository and mirrors the skill layout under [skills](../skills).
...
- [crosby-issue-refine](engineering/crosby-issue-refine/README.md)
- [crosby-debug-root-cause](engineering/crosby-debug-root-cause/README.md)
- [crosby-test-design](engineering/crosby-test-design/README.md)
- [crosby-ci-triage](engineering/crosby-ci-triage/README.md)
- [crosby-release-readiness](engineering/crosby-release-readiness/README.md)
- [crosby-dependency-upgrade](engineering/crosby-dependency-upgrade/README.md)
- [crosby-postmortem-create](engineering/crosby-postmortem-create/README.md)
- [crosby-skill-review](engineering/crosby-skill-review/README.md)
...
These pages are intended to help a human quickly understand:

- what a skill is for,
- when to choose it,
- what workflow it follows,
- and what output it is expected to produce.

They summarize the repo’s skill instructions without replacing the source files under [skills](../skills).
