...
"Use the `crosby-prompt-create` skill to improve this rough request into a prompt for a senior technical reviewer. Ask only blocking questions, narrow the scope to one outcome, and return a copy-ready draft."
