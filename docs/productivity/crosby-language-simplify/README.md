...
You invoke this skill by typing `/crosby-language-simplify`, and the agent will not reach for it on its own.

Reach for it when a prompt feels long, vague, repetitive, technical, or difficult to scan. For a new workflow, use [crosby-plan-iterative](../../engineering/crosby-plan-iterative/README.md) instead.
